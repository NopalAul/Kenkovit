...
const ProductCard: React.FC<ProductCardProps> = ({ id }) => {
  ...
  return (
    <Link href={`/product/${id}`} passHref>
      <div className={`cursor-pointer max-w-[250px] w-[full] md:w-[290px] md:h-[350px] rounded-2xl shadow-card md:shadow-cardCombined ${product.bgColor} flex flex-col items-center justify-between transition-transform hover:scale-105`}>
