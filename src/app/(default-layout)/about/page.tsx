...
export default function AboutPage() {
  return (
    <div className="bg-gray-50 py-32 px-[9vw]">
      {/* Section Container */}
      <div className="max-w-5xl mx-auto space-y-20 md:space-y-36">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="md:w-1/2">
            <Image src="/images/model4.svg" alt="Our Mission" width={400} height={300} className="rounded-lg shadow-cardCombined" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8">
          ...
          <div className="md:w-1/2 flex justify-center">
            <Image src="/images/model3.svg" alt="Who We Are" width={400} height={300} className="rounded-lg shadow-cardCombined" />
          </div>
        </div>
